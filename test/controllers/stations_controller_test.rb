...
class StationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post stations_url, params: { station: { number: @station.number, station_name: @station.station_name, t_zone: @station.t_zone } }
    end
  ...
  test "should update station" do
    patch station_url(@station), params: { station: { number: @station.number, station_name: @station.station_name, t_zone: @station.t_zone } }
